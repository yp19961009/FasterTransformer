...
template<typename T>
ZipformerEncoder<T>::ZipformerEncoder(size_t           layers_num,
                                        size_t           in_dim,
                                        size_t           head_num,
...
{
    zipformer_attn_layer_ = new LongformerAttentionLayer<T>(head_num,
                                                             size_per_head,
